    ...
    <div class="container position-relative">
      <div class="row align-items-center justify-content-center g-4">
        <div class="col-12 col-lg-6">
          <div class="hero-panel text-white p-4 p-lg-5 shadow-lg position-relative overflow-hidden">
            ...
            <p class="fs-5 text-white-50 mb-4">Dashboard interaktif dengan elemen abstrak yang modern, menjadikan pengalaman login lebih menarik.</p>
            ...
            <div class="row g-3 text-center text-lg-start">
              ...
              <div class="col-12 col-lg-4">
                <div class="stat-badge">
                  <div class="fw-bold fs-4">Tren</div>
