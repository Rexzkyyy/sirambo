    ...
    <table class="w-full text-xs relative lk-sticky-table">
        ...
        <tbody id="{{ $rowsId }}" data-next-row="{{ $itemRows->count() }}">
            @forelse($itemRows as $index => $item)
                ...
                @endphp
                <tr class="hover:bg-orange-50/40" data-template="kehutanan">
            ...
            @empty
                <tr><td colspan="12" class="border border-slate-200 px-3 py-6 text-center text-slate-500">Belum ada komoditas untuk wilayah ini.</td></tr>
            @endforelse
        </tbody>
        <tfoot>
            <tr class="bg-slate-100 font-semibold text-[10px] md:text-sm">
                <td colspan="4" class="border border-slate-300 px-2 py-2 text-right">Total</td>
                <td class="border border-slate-300 px-2 py-2 text-right bg-blue-50/40" {{ $totalPrefix }}="kuantum" data-total="kuantum">0</td>
                <td class="border border-slate-300 px-2 py-2 text-right bg-blue-50/40" {{ $totalPrefix }}="nilai_output_utama" data-total="nilai_output_utama">0</td>
                <td class="border border-slate-300 px-2 py-2"></td>
                <td class="border border-slate-300 px-2 py-2 text-right bg-green-50/40" {{ $totalPrefix }}="nilai_output_ikut" data-total="nilai_output_ikut">0</td>
                <td class="border border-slate-300 px-2 py-2 text-right bg-blue-100/40" {{ $totalPrefix }}="output_adh" data-total="output_adh">0</td>
                <td class="border border-slate-300 px-2 py-2"></td>
                <td class="border border-slate-300 px-2 py-2 text-right bg-orange-50/40" {{ $totalPrefix }}="konsumsi_antara" data-total="konsumsi_antara">0</td>
                <td class="border border-slate-300 px-2 py-2 text-right bg-slate-50" {{ $totalPrefix }}="nilai_ntb" data-total="nilai_ntb">0</td>
                <td class="border border-slate-300 px-2 py-2"></td>
            </tr>
        </tfoot>
    </table>
...
<template id="template-row-kehutanan">
    <tr class="hover:bg-orange-50/40" data-template="kehutanan">
        ...
        <td class="border border-slate-200 px-1 py-1">
            <input type="text" name="new_rows[INDEX][wujud]" class="lk-input w-full px-1 py-1 border border-slate-200 rounded focus:border-orange-400">
        </td>
        <td class="border border-slate-200 px-1 py-1">
